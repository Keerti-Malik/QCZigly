...
public class couponcode_Blank_validation {

	@Test()
	public void blankcouponcode() throws InterruptedException
	// public static void main(String[] args) throws InterruptedException
	{
		...
		Thread.sleep(2000);
		System.out.println("Message-" + driver.findElement(By.id("coupon_code-error")).getText());
	}
