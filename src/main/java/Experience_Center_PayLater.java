...
public class Experience_Center_PayLater {
	...
	@Test()
	public void experiencecentre() throws Exception
	{
    ...
    public void login() throws InterruptedException {
		...
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//*[@id=\"location-modal\"]/div/span[3]/div"))).click();
    ...
    public void bookEC() throws Exception
    {
    	...
    	// click on paylater
    		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//*[@id=\"groomer-service\"]/fieldset[5]/div/div/div/div/div[2]/div[2]/div[6]/fieldset[2]/label"))).click();
       // click on Make Payment
    		driver.findElement(By.xpath("//*[@id=\"groomer-service\"]/fieldset[5]/div/div/div/div/div[2]/div[2]/button")).click();
