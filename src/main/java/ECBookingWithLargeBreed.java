...
public class ECBookingWithLargeBreed {
	...
	public void bookingECLBreed() throws Exception {
		Thread.sleep(2000);
		// Select Pet
		WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(30));
		...
		List<WebElement> list1 = driver
				.findElements(By.xpath("//div[@class='plans-grid']/div/div/div[6]/button"));
		for (int i = 0; i <list1.size(); i++) {
			System.out.println(list1.get(i).getText());
			Thread.sleep(1000);
			List<WebElement> itemSelect= driver.findElements(By.xpath("//div[@class='detail-options service-list']/ul/li/label"));
		...
		// select date
		 ...
		 "//*[@id=\"grooming-calendar-slot\"]/div[2]/div/table/tbody/tr/td/div/div/div/table/tbody/tr[3]/td[4]/div/div[1]"
		  ...
		  // Select time
		  wait.until(ExpectedConditions.elementToBeClickable(By.xpath(
		  "//*[@id=\"grooming-timeslot\"]/ol/li[15]"))) .click(); 
		  // click on next
		  driver.findElement(By.xpath("//*[@id=\"time-proceed-73\"]")).click();
		  Thread.sleep(2000); driver.findElement(By.xpath(
		  "//*[@id=\"groomer-service\"]/fieldset[4]/div[1]/ul/li")).click();
		  
		  // select address
		  
		  driver.findElement(By.xpath("//div[@class='action-address']/button[1]")).
		  click(); Thread.sleep(2000);
		  
		  // click on paylater
		  wait.until(ExpectedConditions.elementToBeClickable(By.xpath(
		  "//*[@id=\"groomer-service\"]/fieldset[5]/div/div/div/div/div[2]/div[2]/div[6]/fieldset[2]/label"
		  ))) .click(); // click on Make Payment 
		  driver.findElement(By.xpath(
		  "//*[@id=\"groomer-service\"]/fieldset[5]/div/div/div/div/div[2]/div[2]/button")) .click();
